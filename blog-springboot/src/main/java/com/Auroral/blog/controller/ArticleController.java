...
public class ArticleController {
    ...
    @ApiOperation(value = "同步文章到ES")
    @GetMapping("/admin/articles/sync")
    public Result<?> syncArticlesToEs() {
        articleService.syncArticlesToEs();
        return new Result<>(true, StatusConst.OK, "同步成功", null);
    }
